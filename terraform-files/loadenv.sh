...
export TF_VAR_app_gmail_email="$GMAIL_EMAIL"
export TF_VAR_app_gmail_app_password="$GMAIL_APP_PASSWORD"
...
echo "  TF_VAR_app_gmail_email"
echo "  TF_VAR_app_gmail_app_password"