...
from app.models.cms.models import (
    College, Department, Branch, Degree, Subject,
    CMSUser, CMSAttendanceSession, CMSAssignment, CMSExamination, 
    CMSEvent, CMSPlacementDrive, CMSNotification, CMSTimetableSlot
)
