...
class College(BaseModel):
    ...
    college_reference_id = Column(
        String(100), nullable=False
    )  # "ACME001" (staff reference)
    ...
    # staff = relationship("Staff", back_populates="college")
    ...
    def full_address(self) -> str:
        ...
        return (
            f"{self.area}, {self.city}, {self.district}, {self.state} - {self.pincode}"
        )
    ...
    def to_dict(self, include_sensitive: bool = False) -> dict:
        ...
        result = {
            ...
            "longitude": str(base_dict["longitude"])
            if base_dict["longitude"]
            else None,
